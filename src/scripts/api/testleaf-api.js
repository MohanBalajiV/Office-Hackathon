class AgentXAPI {
    constructor(apiKey) {
        this.apiKey = apiKey;
        this.baseUrl = 'https://api.AgentX.com/ai/v1/chat/completions';
    }

    async sendMessage(prompt, modelName) {
        try {
            console.log('Sending request to AgentX API...');
            ...
            console.log('AgentX API response:', data);
